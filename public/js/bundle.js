...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHVhbm54MTIzIiwiYSI6ImNsZmo0bWR4ZTBhbDgzeW11NWt1anllcnQifQ.TUConnQujP_e9GhbJDA-wQ';
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51MqAGwFZzcLmcWM4mXhn2d6w2LGVsIt6OBzQpIFLEblQ0myNjKR1fvo35DnT1W8NDyMipQ4Cvfbb1hWVPla9tZZZ00lbBtE9Xz'); // get checkout session from API
          _context.prev = 1;
          _context.next = 4;
